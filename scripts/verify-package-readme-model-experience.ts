...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/remote/remote': { kind: 'indirect', reason: 'The service interface delegates all model rendering to dsh-tool-remote.' },
  'packages/remote/remote-ssh2': { kind: 'indirect', reason: 'The SSH2 backend delegates all model rendering to dsh-tool-remote.' },
  ...
  'packages/client/ui-llmpwa-pipeline': { kind: 'none', reason: 'Browser-side workbench that previews a logged pipeline_state.json DAG; registers nothing model-facing.' },
  ...
  'packages/web/web-easytransnote': { kind: 'indirect', reason: 'The provider backends delegate model rendering to dsh-tool-web.' },
