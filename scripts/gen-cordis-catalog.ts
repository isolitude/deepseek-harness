...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  RemoteAuth: 'remote.md',
  RemoteConnection: 'remote.md',
  RemoteEditRequest: 'remote.md',
  RemoteEditResult: 'remote.md',
  RemotePullRequest: 'remote.md',
  RemotePushRequest: 'remote.md',
  RemoteReadLine: 'remote.md',
  RemoteReadRequest: 'remote.md',
  RemoteReadResult: 'remote.md',
  RemoteRunRequest: 'remote.md',
  RemoteRunResult: 'remote.md',
  RemoteTransferResult: 'remote.md',
  RemoteWriteRequest: 'remote.md',
  RemoteWriteResult: 'remote.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WorkspaceFileWrite: 'Host workspace file endpoint contract is owned by packages/api/workspace-files/README.md',
