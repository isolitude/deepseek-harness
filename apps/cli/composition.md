...
flowchart LR
  ...
  plugin_dsh_base_web_easytransnote["web-easytransnote<br/>@deepseek-ai/dsh-web-easytransnote"]
  cfg --> plugin_dsh_base_web_easytransnote
...
| `web-easytransnote` | `@deepseek-ai/dsh-web-easytransnote` |
