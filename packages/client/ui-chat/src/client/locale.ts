...
export const zh = {
  ...
  'embedded.empty': '暂无对话',
  'embedded.placeholder': '输入消息，Enter 发送，Shift+Enter 换行',
  'embedded.send': '发送',
  'embedded.running': '运行中',
  'embedded.role.user': '我',
  'embedded.role.assistant': '助手',
...
export const en = {
  ...
  'embedded.empty': 'No messages',
  'embedded.placeholder': 'Type a message; Enter to send, Shift+Enter for a new line',
  'embedded.send': 'Send',
  'embedded.running': 'Running',
  'embedded.role.user': 'You',
  'embedded.role.assistant': 'Assistant',
